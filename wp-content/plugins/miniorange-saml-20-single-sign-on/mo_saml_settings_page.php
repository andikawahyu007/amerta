    ...
    <div id="mo_saml_settings" >
        ...
        <div class="wrap">
            <h1>
                ...
                <a id="license_upgrade" class="add-new-h2 add-new-hover" style="background-color: orange !important; border-color: orange; font-size: 16px; color: #000;" href="<?php echo add_query_arg( array( 'tab' => 'licensing' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>"><?php _e('Upgrade Now','miniorange-saml-20-single-sign-on'); ?></a>
                ...
                <tr>
                    <h2 class="nav-tab-wrapper">
                        ...
                        <a class="nav-tab <?php echo $active_tab == 'licensing' ? 'nav-tab-active' : ''; ?>"
                           href="<?php echo add_query_arg( array( 'tab' => 'licensing' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>"><?php _e('Premium plans','miniorange-saml-20-single-sign-on');?></a>
                    ...
                    <td style="vertical-align:top;padding-left:1%;" id="support-form">
                        ...
                        if($active_tab === 'opt' && get_option('mo_saml_test_config_attrs')){
                          echo  mo_saml_display_attrs_list();
                            ...
                            miniorange_support_saml($active_tab,false);
                        }
                        else{
...
function miniorange_support_saml($active_tab, $display_keep_configuration_intact=true) {
    ?>
    ...
    if($display_keep_configuration_intact)
        ...
        if($active_tab=='account-setup' || $active_tab=='support' || $active_tab=='opt')
